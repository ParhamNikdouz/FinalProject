    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					<form class="form-horizontal" method="POST" action="{{ route('ReportStu', ['id' => $terms[0]->id ]) }}">
                        {{ csrf_field() }}
						<div class="form-group">
							...
							<a href="{{ route('ReportStu', ['id' => $terms[0]->id ]) }}">
        ...
        <div class="col-md-12">
            <div class="panel panel-default" style="direction:rtl;">
                ...
                <div class="panel-body">           
				  ...
				  <input type="button" id="btn" class="btn btn-info" value="چاپ" onclick="printPage()" />
				</div>
			</div>
		</div>
	</div>
