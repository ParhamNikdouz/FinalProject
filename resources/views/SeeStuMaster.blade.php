        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
					<a href="/home">Home</a>
					<br/>
				    <a href="/ReportStuMaster">Report Student</a>
				    <br/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					<form class="form-horizontal" method="POST" action="{{-- route('SeeStuFilter', ['id' => $terms[0]->id ]) --}}">
                        {{ csrf_field() }}
						<div class="form-group">
							...
							<a href="{{-- route('SeeStuFilter	', ['id' => $terms[0]->id ]) --}}">
